...
our %config = (
  ...
  baseaddr => "0xFB00000",
  bn_ll => "0",
  build_file_template => "/root/asmlib/openssl/Configurations/unix-Makefile.tmpl",
  ...
  makedepprog => "gcc",
  minor => "1.0",
  openssl_algorithm_defines => [ "OPENSSL_NO_ASAN", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_EC_NISTP_64_GCC_128", "OPENSSL_NO_EGD", "OPENSSL_NO_FUZZ", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_MD2", "OPENSSL_NO_RC5", "OPENSSL_NO_SCTP", "OPENSSL_NO_SSL_TRACE", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_UBSAN", "OPENSSL_NO_UNIT_TEST", "OPENSSL_NO_WEAK_SSL_CIPHERS" ],
  openssl_api_defines => [  ],
  openssl_other_defines => [  ],
  openssl_sys_defines => [  ],
  openssl_thread_defines => [ "OPENSSL_THREADS" ],
  openssldir => "",
  options => "--prefix=/opt/openssl -Wa,--noexecstack no-asan no-crypto-mdebug no-crypto-mdebug-backtrace no-ec_nistp_64_gcc_128 no-egd no-fuzz no-heartbeats no-md2 no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl => "/usr/bin/perl",
  perlargv => [ "linux-x86_64", "--prefix=/opt/openssl", "-Wa,--noexecstack" ],
  prefix => "/opt/openssl",
  processor => "",
...
our %disabled = (
  ...
  "crypto-mdebug-backtrace" => "forced",
